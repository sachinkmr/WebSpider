...
//        return false;
        return (url != null && !url.contains("?")&&url.startsWith(config.getModifiedSiteName()) && (!FILTERS.matcher(url).find())&&!url.contains("/recipes/detail"));
    }
...
//    }
    void go() {
        ...
        config.setUserAgentString("Mozilla/5.0 (iPhone; CPU iPhone OS 9_1 like Mac OS X) AppleWebKit/601.1.46 (KHTML, like Gecko) Version/9.0 Mobile/13B143 Safari/601.1");
